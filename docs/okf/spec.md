...
description: Vendored copy of the OKF v0.2 spec that Sunstone's frontmatter model conforms to.
resource: https://github.com/GoogleCloudPlatform/open-knowledge-format/blob/main/SPEC.md
tags: [okf, spec, frontmatter, reference]
---

> **Provenance.** This is a vendored, verbatim copy of the upstream OKF specification,
> kept here for offline reference. The canonical source is
> <https://github.com/GoogleCloudPlatform/open-knowledge-format/blob/main/SPEC.md>.
> Re-fetch from upstream before relying on it for anything authoritative.
> Captured: 2026-09-16. Version captured: **0.2**.
>
> The spec moved repositories between v0.1 and v0.2. The `okf/` directory in
> `GoogleCloudPlatform/knowledge-catalog` — where the previous vendored copy came
> from — is a frozen v0.1-era snapshot and **must not** be re-fetched from.
