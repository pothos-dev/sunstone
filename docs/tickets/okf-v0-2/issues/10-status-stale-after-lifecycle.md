...
- [ ] In an OKF Bundle, lint reports a `status` outside `draft | stable | deprecated` as an error and completion offers the three values; in a non-OKF Bundle it says nothing ([02b](02b-okf-language-service.md))
