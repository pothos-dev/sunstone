...
- [ ] In an OKF Bundle, lint reports a `generated` block missing `by` as an error and a non-ISO `at` as a warning; in a non-OKF Bundle it says nothing ([02b](02b-okf-language-service.md))
