...
- **`src/lib/components/`** — desktop components (`Tile`, `TileHeader`, `Tree`, `ActivityRail`, `SidebarEdge`, `Outline`, `Backlinks`, `Frontmatter`, `SearchPanel`, `QuickNav`, `Launcher`, …) — the [interface](/interface/index.md) surfaces.
