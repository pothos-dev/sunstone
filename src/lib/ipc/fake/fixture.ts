// The seeded markdown fixture for the fake backend's Bundle.
//
// This is the pristine SEED data only — the mutable working-tree state built
// from it (`FILES`, `FOLDERS`, `COMMITTED_FILES`) lives in `./store`, which is
// the module every other fake module imports for live shared state. Nothing
// should import this fixture except `./store`.

/** Seed map of bundle-relative path -> raw markdown content. */
