...
# 02: Embedded SVGs inherit the editor's colour scheme
...
- [ ] Sizing from [01](01-embedded-images-in-concepts.md) (`![[d.svg|300]]`) applies to inlined SVGs too
