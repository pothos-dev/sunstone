...
- **`src/lib/components/`** — desktop components (`Tile`, `TileHeader`, `Tree`, `ActivityRail`, `Sidebar`, `SidebarEdge`, `Outline`, `Backlinks`, `Frontmatter`, `SearchPanel`, `QuickNav`, `Launcher`, …) — the [interface](/interface/index.md) surfaces.
