...
- Explorer: right-clicking a folder (or its reserved-file symbol) now offers
  "Delete index.md" / "Delete log.md" for whichever reserved files exist,
  with the usual delete confirmation.
